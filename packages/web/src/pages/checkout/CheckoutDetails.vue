<template>
  <h2>Step 1: <span class="white">Enter Details</span></h2>
	<form @submit.prevent="submitForm">
		...
		<div class="form-control-container">
			...
			<div class="form-control radio-buttons1 plan">
				<label for="plan-one">
					<input id="plan-one" type="radio" value="1" name="plan" v-model="plan" />
					<div class="one-year hollow-button">1 year</div>
				</label>
				<label for="plan-two">
					<input id="plan-two" type="radio" value="2" name="plan" v-model="plan">
					<div class="two-year hollow-button">2 years</div>
				</label>
				<label for="plan-three">
					<input id="plan-three" type="radio" value="3" name="plan" v-model="plan">
					<div class="three-year hollow-button">3 years</div>
				</label>
				<label for="plan-four">
					<input id="plan-four" type="radio" value="4" name="plan" v-model="plan">
					<div class="four-year hollow-button">4 years</div>
				</label>
				<label for="plan-five">
					<input id="plan-five" type="radio" value="5" name="plan" v-model="plan">
...
<script>
	export default {
		...
		methods: {
			onPaymentBtnClick() {
				// TODO: Send order information to server and get payment intent.
